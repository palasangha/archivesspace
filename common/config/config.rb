...
# SLUG BRANCH
#AppConfig[:db_url] = "jdbc:mysql://127.0.0.1:3306/archivesspace_slug?useUnicode=true&characterEncoding=UTF-8&user=root&password="

# OTHER BRANCHES
AppConfig[:db_url] = "jdbc:mysql://127.0.0.1:3306/archivesspace?useUnicode=true&characterEncoding=UTF-8&user=root&password=&serverTimezone=UTC"
# AppConfig[:db_url] = "jdbc:mysql://127.0.0.1:3306/bs25?useUnicode=true&characterEncoding=UTF-8&user=root&password=&serverTimezone=UTC"
...
# AppConfig[:oai_sets] = {
  # 'repository_set' => {
    # :repo_codes => ['GoneRepoA', 'destination', 'DefaultValues'],
...
AppConfig[:pui_hide][:record_badge] = false # hide by default
...
AppConfig[:path_to_java] = "/usr/bin/java"